...
\begin{document}
	...
	\label{section:The lid-driven cavity problem}
		...
		\begin{figure}[h!]
			...
			\hspace*{0.5cm}
			\stackunder[-6pt]{\includegraphics[scale = 0.22, trim = {4.5cm 0 3cm 0.4cm}, clip]{dc_400_fem_vx_4}}{\footnotesize{$\bg{\mu} = (1.78, \, 1.99, \, 2.29)$, FEM}} \\[0.4cm]
			...
			\hspace*{0.5cm}
			\stackunder[-6pt]{\includegraphics[scale = 0.22, trim = {4.5cm 0 3cm 0.4cm}, clip]{dc_400_podnn_vx_4}}{\footnotesize{$\bg{\mu} = (1.78, \, 1.99, \, 2.29)$, POD-NN}}
		...
		\begin{figure}[t]
			...
			\hspace*{0.5cm}
			\stackunder[-6pt]{\includegraphics[scale = 0.22, trim = {4.5cm 0 3cm 0.4cm}, clip]{dc_400_fem_stream_4}}{\footnotesize{$\bg{\mu} = (1.78, \, 1.99, \, 2.29)$, FEM}} \\
			...
			\hspace*{0.5cm}
			\stackunder[-6pt]{\includegraphics[scale = 0.22, trim = {4.5cm 0 3cm 2cm}, clip]{dc_400_podnn_stream_4}}{\footnotesize{$\bg{\mu} = (1.78, \, 1.99, \, 2.29)$, POD-NN}}
